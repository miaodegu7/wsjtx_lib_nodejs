...
void mskrtd_(short int id2[], int *nutc0, float *tsec, int *ntol,
			 int *nrxfreq, int *ndepth, char mycall[], char hiscall[],
			 bool *bshmsg, bool *btrain, double pcoeffs[], bool *bswl,
			 char datadir[], char line[],
			 fortran_charlen_t, fortran_charlen_t, fortran_charlen_t,
			 fortran_charlen_t);
...
void multimode_decoder_(float *ss, short int *id2, params_t *p, int *nfsample);
}
